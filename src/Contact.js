                ...
                <div className="mt-12 mx-auto px-24 p-8 bg-white sm:max-w-lg sm:px-8 sm:rounded-xl">
                    ...
                    >
                        ...
                        <div>
                            ...
                            <textarea required className="w-full mt-2 h-56 px-3 py-1 resize-none appearance-none bg-transparent outline-none border focus:border-gray-800 shadow-sm rounded-lg" placeholder="..."></textarea>
                        </div>
                        <button
